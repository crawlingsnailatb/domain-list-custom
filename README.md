...
⑤ ***\*****`ads.list`*****\*** 源采用 [privacy-protection-tools/anti-AD](https://github.com/privacy-protection-tools/anti-AD)  删除 [privacy-protection-tools/dead-horse](https://github.com/privacy-protection-tools/dead-horse) 以及 @master [myfile/my-ad-white](https://github.com/crawlingsnailatb/domain-list-custom/tree/master/myfile) 中的域名
...
㉒***\*****`ad-white.list`*****\***  源采用[myfile/my-ad-white](https://github.com/crawlingsnailatb/domain-list-custom/tree/master/myfile) 中的不在 ads.list 中的域名